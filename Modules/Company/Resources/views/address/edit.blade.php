...
@section('content')
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            <!-- page info start-->
            {!!  Form::open(['route' => [ 'mng.addresses.update', $address->id ] , 'method' => 'post', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="row clearfix">
                    ...
                    <div class="add-new-page  bg-white p-20 m-b-20">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <label for="name" class="col-form-label font-weight-bold">{{$address->company->name}}</label>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="full_address" name="full_address" value="{{$address->full_address }}" required type="text"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input id="city" name="city" value="{{ $address->city }}" required type="text"
                                       class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-12">
				...
				<input id="state" name="state" value="{{ $address->state  }}" required type="text"
				       class="form-control">
                            </div>
                        </div>
			<div class="col-sm-12">
                              <div class="form-group">
                                  ...
                                  <select class="form-control" name="country" id="country">
                                      @foreach($countries as $country)
                                          <option
                                              @if($country->name->common == $address->country) Selected
                                              @endif
